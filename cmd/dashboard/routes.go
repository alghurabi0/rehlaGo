...
func (app *application) routes() http.Handler {
	...
	//mux.Handle("GET /courses/{courseId}/lecs", isLoggedIn.ThenFunc(app.lecsPage))
	//mux.Handle("GET /courses/{courseId}/exams", isSubscribed.ThenFunc(app.examsPage))
	//mux.Handle("GET /courses/{courseId}/lecs/{lecId}", isLoggedIn.ThenFunc(app.lecPage))
	//mux.Handle("GET /courses/{courseId}/exams/{examId}", isSubscribed.ThenFunc(app.examPage))
